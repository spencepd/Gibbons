...
class CharitiesControllerTest < ActionController::TestCase
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post :create, charity: { accountability: @charity.accountability, description: @charity.description, financial: @charity.financial, name: @charity.name, overall: @charity.overall }
    end
  ...
  test "should update charity" do
    put :update, id: @charity, charity: { accountability: @charity.accountability, description: @charity.description, financial: @charity.financial, name: @charity.name, overall: @charity.overall }
    assert_redirected_to charity_path(assigns(:charity))
  end
